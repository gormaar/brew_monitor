...
func (server *Server) initializeRoutes() {
	...
	server.Router.HandleFunc("/api/allRespiration/{brew_id}", server.GetAllRespirations).Methods("GET")
	...
	server.Router.HandleFunc("/api/temp/{brew_id}/{id}", server.GetTemperatureData).Methods("GET")
	server.Router.HandleFunc("/api/hourlyTemp/{brew_id}", server.GetAllTemperatureData).Methods("GET")
